...
const Section7 = () => {
    return (
        <div>
            <div className="flex flex-col items-center gap-[8px] text-center px-[166px] py-[5px] font-inter">
            ...
            <div className='flex px-[144px] justify-between items-center'>
                ...
                <div className='flex flex-col items-center'>
                    <div><img src={ two }/></div>
                    <div className='flex p-[16px] flex-col items-center gap-[16px] bg-[#F5F7FA] rounded-[8px] shadow-[0px 8px 16px 0px rgba(171, 190, 209, 0.40);] mt-[-96px]'>
                        <p className='w-[285px] text-center text-[#717171] text-[20px] font-[600]'>What are your safeguarding responsibilities and how can you manage them?</p>
                        <div className='flex p-[8px] justify-center items-center gap-[8px] self-stretch'>
                            <p className='text-[#4CAF4F] text-[20px] font-[600]'>Readmore</p>
                            <img src={ arrow }/>
                        </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <div className='flex p-[16px] flex-col items-center gap-[16px] bg-[#F5F7FA] rounded-[8px] shadow-[0px 8px 16px 0px rgba(171, 190, 209, 0.40);] mt-[-96px]'>
                        <p className='w-[285px] text-center text-[#717171] text-[20px] font-[600]'>Revamping the Membership Model with Triathlon Australia</p>
                        <div className='flex p-[8px] justify-center items-center gap-[8px] self-stretch'>
                            <p className='text-[#4CAF4F] text-[20px] font-[600]'>Readmore</p>
                            <img src={ arrow }/>
                        </div>
