...
const Section4 = () => {
    return (
        <div className="flex flex-col md:flex-row px-[40px] lg:px-[50px] xl:px-[144px] py-[64px] justify-between items-center bg-[#F5F7FA]">
            ...
            <div className='flex flex-col items-center gap-[40px]'>
                <div className='flex items-center gap-[30px]'>
                    <div className='flex items-center gap-[16px]'>
                        <div className='px-[5px] lg:px-0'><img src={ mem }/></div>
                        <div>
                            <p className='text-[20px] lg:text-[28px] text-[#4D4D4D] font-[700]'>2,245,341</p>
                            <p className='text-[16px] text-[#717171]'>Members</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-[16px]'>
                        <div className='px-[5px] lg:px-0'><img src={ clubs }/></div>
                        <div>
                            <p className='text-[20px] lg:text-[28px] text-[#4D4D4D] font-[700]'>46,328</p>
                ...
                <div className='flex items-center gap-[30px]'>
                    <div className='flex items-center gap-[16px]'>
                        <div className='px-[5px] lg:px-0'><img src={ events }/></div>
                        <div>
                            <p className='text-[20px] lg:text-[28px] text-[#4D4D4D] font-[700]'>828,867</p>
                            <p className='text-[16px] text-[#717171]'>Event Bookings</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-[16px]'>
                        <div className='px-[5px] lg:px-0'><img src={ pay }/></div>
                        <div>
                            <p className='text-[20px] lg:text-[28px] text-[#4D4D4D] font-[700]'>1,926,436</p>
