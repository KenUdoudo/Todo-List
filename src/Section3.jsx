...
const Section3 = () => {
    return (
        <div className="flex flex-col-reverse md:flex-row justify-between items-center px-[40px] lg:px-[100px] xl:px-[144px] self-stretch font-inter">
            <div className='px-[30px] md:px-0'><img src={ three }/></div>


            <div className="flex flex-col items-center md:items-start gap-[10px] lg:gap-[20px] xl:gap-[32px] w-full md:w-3/5 lg:w-2/4">
                <h2 className="px-[20px] md:px-0 text-[25px] md:text-[30px] lg:text-[36px] text-[#4D4D4D] font-semibold text-center md:text-left">The unseen of spending three years at Pixelgrade</h2>
