...
const Section5 = () => {
    return (
        ...
        <div className="flex flex-col items-center md:items-start gap-[10px] lg:gap-[20px] xl:gap-[32px] w-full md:w-3/5 lg:w-2/4">
            <h2 className="px-[20px] md:px-0 text-[25px] md:text-[30px] lg:text-[36px] text-[#4D4D4D] font-semibold text-center md:text-left">How to design your site footer like we did</h2>
